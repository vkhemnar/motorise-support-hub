...
export const LoginForm = () => {
  ...
  return <div className="min-h-screen flex items-center justify-center bg-[var(--gradient-card)] p-4">
      <Card className="w-full max-w-md card-electric">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            {step === 'phone' ? 'Enter your mobile number to get started' : `We've sent a 6-digit code to ${phone}`}
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          {step === 'phone' ? <form onSubmit={handlePhoneSubmit} className="space-y-4">
              ...
              <Button type="submit" className="w-full btn-electric" disabled={isSubmitting}>
